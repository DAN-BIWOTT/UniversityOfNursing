      ...
      <Container>
        <Box sx={styles.grid}>
          <Box as="form" sx={styles.domainCard}>
            <Heading>
              Get Professional Nursing Writers For Your Projects
            </Heading>
            <H3>Why Choose Us?</H3>
            <List>
              <ul>
                <li>
                  Prices: cheap and based on complexity of assistance needed.
                </li>
                <li>
                  Diversification of skills: services for all nursing cadres
                  (BSN, MSN/APRN, and DNP) and disciplines (research, education,
                  and practice, etc.)
                </li>
                <li>
                  Freebies: Title page, revisions, plagiarism reports,
